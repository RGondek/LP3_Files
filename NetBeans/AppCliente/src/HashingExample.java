...
public class HashingExample {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException,
        ...
        String senhaOriginal = "minhaSenhaForte";
        String hashSeguroDaSenha = generateStrongPasswordHash(senhaOriginal);
        System.out.println(hashSeguroDaSenha);
        boolean matched = validaSenha("minhaSenhaForte", hashSeguroDaSenha);
        System.out.println(matched);
        matched = validaSenha("minhaSenha", hashSeguroDaSenha);
        System.out.println(matched);
    }
    ...
    private static String toHex(byte[] array) throws NoSuchAlgorithmException {
        ...
        int paddingLength = (array.length * 2)
                - hex.length();
        if (paddingLength > 0) {
